...
function getOptionsMap(props) {
  ...
  function toMaps(options) {
    options.forEach(function (option) {
      if (option[childrenField] && (0, _isArray.default)(option[childrenField])) {
  ...
  (0, _createClass2.default)(Select, [{
    ...
    value: function renderDropDownList() {
      ...
      var _this$state3 = this.state,
          ...
          optionsMap = _this$state3.optionsMap;
    ...
    value: function render() {
      ...
      var _this$state4 = this.state,
          ...
          popupVisible = _this$state4.popupVisible;
...
/******/ });
//# sourceMappingURL=index.173aa819.js.map